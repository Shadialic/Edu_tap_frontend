...
function Acoount({ formData, setFormData }) {
  // useEffect(() => {
              ...
              <Card className="w-[80%] mt-5 ml-[10%] border-[1px] rounded-xl p-3 border-[#d3d2d2]  ">
                <div className="flex flex-row gap-5">
                  <div className="flex flex-col gap-5 mt-4">
                    <h1 className="uppercase font-prompt text-xl rounded-md h-12 p-6 text-white bg-violet-600 text-center flex items-center justify-center">
                      Full Name
                    </h1>
                    <h1 className="uppercase font-prompt text-xl rounded-md h-12 p-6 text-white bg-violet-600 text-center flex items-center justify-center">
                      Email
