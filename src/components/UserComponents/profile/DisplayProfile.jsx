...
// import update from "../../../../public/images/user/updateImage.png";
import { UpdateProfile, profileuser } from "../../../api/userApi";
...
function DisplayProfile() {
  ...
  useEffect(() => {
    console.log(userInfo.email, "ssss");
    profileuser({ email: userInfo.email }).then((res) => {
      console.log(res, "res");
      ...
      <div className="bg-authentication-background bg-cover bg-gray-100 flex justify-center items-center w-[100%] h-screen py-7 px-5">
        ...
        <div className="z-20 flex w-[70%] h-[90%] ">
          <div className="flex-col w-full h-full bg-white-400 shadow-lg mr-36 justify-start items-start">
            <Acoount formData={formData} setFormData={setFormData} />
