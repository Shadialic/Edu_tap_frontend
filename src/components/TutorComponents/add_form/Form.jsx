...
//     const cloudinaryResponse = await cloudinary.uploader.upload(formData, {
...
//       console.log('Selected file:', file);  // Check if the correct file is selected
//       const url = await uploadImage(file);
//       console.log('Uploaded image URL:', url);  // Check the uploaded image URL
//       setProfilePic(url);
//     } catch (error) {
